...
import { Card, CardHeader, CardFooter, Divider, Image as UIimage, Button} from "@heroui/react"
        ...
        <div className="max-w-5xl mx-auto mt-4 p-5">
            ...
            >
                {events?.map((event, index)=>(
                    ...
                    key={`${event._id}+${index}`}
                    isFooterBlurred
                    className="w-full min-h-200 col-span-12 sm:col-span-7s"
                    >
                        <CardHeader
                            className="absolute z-10 top-0 flex-col items-start bg-black/40"
                        >
                        ...
                        <CardFooter className="absolute bg-black/40 bottom-0">
